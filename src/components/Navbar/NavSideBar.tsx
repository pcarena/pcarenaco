                ...
                <div className='my-15'>
                    ...
                    }
                    {
                        env === 'development' ?
                            <>
                                <hr /> 
                                <Text subtitle className='mt-3 !text-[18px]'>Find Laptop</Text>
                                <Sidebar /> <LinkTo href='/pages/tutorial/all-components.tsx' passHref className='text-[16px] block my-3'>

...
const ContactUs = () => {
    const PAGE_SEO: iSEO = {
        title: 'Contact Us',
        description: 'For any any queries related to this project / template feel free to connect with us on pcarenaco@gmail.com',
        keywords: 'PCArena, contact us,pcarenaco@gmail.com',
        author: 'Pcarena'
    } 
    return (
